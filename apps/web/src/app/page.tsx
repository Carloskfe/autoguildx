    ...
    <main className="min-h-screen flex flex-col">
      ...
      <header className="border-b border-surface-border px-6 py-4 flex items-center justify-between">
        ...
        <nav className="flex gap-4">
          ...
          <Link href="/signup" className="btn-primary text-sm">Join Free</Link>
        </nav>
      </header>
      ...
      <section className="flex-1 flex flex-col items-center justify-center text-center px-6 py-24 gap-8">
        ...
        <p className="text-gray-400 text-lg md:text-xl max-w-xl">
          The professional network and marketplace for specialized mechanics, manufacturers, and collectors in the United States.
        </p>
        <div className="flex flex-wrap gap-4 justify-center">
          <Link href="/signup" className="btn-primary text-base px-8 py-3">Get Started Free</Link>
          <Link href="/discover" className="btn-secondary text-base px-8 py-3">Explore Platform</Link>
        </div>
      </section>
      ...
      <section className="border-t border-surface-border px-6 py-16">
        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8">
          {[
            { title: 'Build Your Presence', desc: 'Showcase your work, expertise, and builds in a professional profile tailored to the automotive niche.' },
            { title: 'Find Trusted Parts', desc: 'Browse a curated marketplace of rare parts and specialized services from verified experts.' },
            { title: 'Connect With Peers', desc: 'Follow builders, attend events, and grow your reputation in the community that knows your craft.' },
          ].map((item) => (
